    ...
    try:
        await m.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("Support Group", url="https://t.me/OMG_info"), InlineKeyboardButton("Bots Channel", url="https://t.me/Discovery_Updates")],
        ...
        try:
            ...
            if event_.forward_from_chat and ((await db.is_user_exist(event_.forward_from_chat.id)) is False):
                try:
                    ...
                    await cb.message.edit(f"Unable to Find Channel!\n\n**Error:** `{err}`", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Support Group", url="https://t.me/OMG_info")]]))
